...
const Paths = struct {
    ...
    // mandatory getters
    pub fn getGL(self: @This()) []const u8 {
        return self.__GL;
    }
    pub fn getX11(self: @This()) []const u8 {
        return self.__X11;
    }
    pub fn getExt(self: @This()) []const u8 {
        return self.__ext;
    }
    pub fn getTmp(self: @This()) []const u8 {
        return self.__tmp;
    }
    pub fn getTmp2(self: @This()) []const u8 {
        return self.__tmp2;
    }
    pub fn getXkbcommon(self: @This()) []const u8 {
        return self.__xkbcommon;
    }
    pub fn getXcb(self: @This()) []const u8 {
        return self.__xcb;
    }
    ...
    pub fn init(builder: *std.Build) !@This() {
        var self = @This(){
            .__GL = try builder.build_root.join(builder.allocator, &.{
                "GL",
            }),
            .__X11 = try builder.build_root.join(builder.allocator, &.{
                "X11",
            }),
            ...
            .__tmp2 = try builder.build_root.join(builder.allocator, &.{
                "tmp2",
            }),
            .__xkbcommon = try builder.build_root.join(builder.allocator, &.{
                "xkbcommon",
            }),
            .__xcb = try builder.build_root.join(builder.allocator, &.{
                "xcb",
            }),
        };
...
fn update_xkbcommon(builder: *std.Build, path: *const Paths, dependencies: *const toolbox.Dependencies) !void {
...
fn update_X11(builder: *std.Build, path: *const Paths, dependencies: *const toolbox.Dependencies) !void {
...
fn update_Xcursor(builder: *std.Build, path: *const Paths, dependencies: *const toolbox.Dependencies) !void {
    ...
    while (tokit.next()) |*token| {
        xcursor_h = try std.mem.replaceOwned(u8, builder.allocator, xcursor_h, match[index], builder.fmt("{s} {s}", .{
            replace[index],
            token.*,
        }));
        index += 1;
...
fn update_Xrandr(builder: *std.Build, path: *const Paths, dependencies: *const toolbox.Dependencies) !void {
...
fn update_Xfixes(builder: *std.Build, path: *const Paths, dependencies: *const toolbox.Dependencies) !void {
...
fn update_Xrender(builder: *std.Build, path: *const Paths, dependencies: *const toolbox.Dependencies) !void {
...
fn update_Xinerama(builder: *std.Build, path: *const Paths, dependencies: *const toolbox.Dependencies) !void {
...
fn update_Xi(builder: *std.Build, path: *const Paths, dependencies: *const toolbox.Dependencies) !void {
...
fn update_XScrnSaver(builder: *std.Build, path: *const Paths, dependencies: *const toolbox.Dependencies) !void {
...
fn update_Xext(builder: *std.Build, path: *const Paths, dependencies: *const toolbox.Dependencies) !void {
...
fn update_xorgproto(builder: *std.Build, path: *const Paths, dependencies: *const toolbox.Dependencies) !void {
...
fn update_xcb(builder: *std.Build, path: *const Paths, dependencies: *const toolbox.Dependencies) !void {
